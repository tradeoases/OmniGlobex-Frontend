...
const UpdateProfileForm = () => {
    ...
    if (isUserSuccess) {
      ...
      form.setValue(
        ...
        user?.profile.number_of_employees
          ? Number(user.profile.number_of_employees)
          : undefined
      );
  ...
  const onSubmit = async (data: z.infer<typeof updateProfileSchema>) => {
    ...
    if (res.status === HttpStatusCode.Ok) {
      setSuccessMsg("Profile information successfully update");
      setTimeout(() => {
        form.reset();
        setSuccessMsg(null);
        navigate("/supplier-dashboard/supplier-profile");
      }, 2000);
    }
  };
      ...
      <div className="container mx-auto px-2 sm:px-4 lg:px-6 py-4 sm:py-6">
        <div className="bg-white rounded-lg shadow-sm p-3 sm:p-4 md:p-6">
          ...
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
            ...
            {successMsg && (
              <div className="bg-main text-white p-4 rounded-md mb-4">
                {successMsg}
              </div>
            )}
            ...
            <div className="xl:w-[280px] w-full">
              <div className="bg-gray-50 p-3 sm:p-4 rounded-lg border border-gray-100">
                  ...
                  <div className="bg-white p-3 sm:p-4 rounded-lg shadow-sm">
                    ...
                    <div className="max-w-[180px] mx-auto">
                      <SingleImageUpload
                        ...
                        image_url={
                          user?.profileImages.find(
                            (r) => r.image_for === "PROFILE"
                          )?.image_url
                        }
                ...
                <p className="text-xs text-gray-500 mt-4 sm:mt-6 text-center px-2">
                  Recommended: Upload high-quality images for better
                  presentation
                </p>
              </div>
            </div>
